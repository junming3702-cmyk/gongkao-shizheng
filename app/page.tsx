...
export default function Home() {
  ...
  return <main className="site-shell">
    <header className="topbar"><div className="brand-lockup"><span className="brand-mark">政</span><span>时政<span className="brand-muted"> · 公考资料库</span></span></div><nav className="topnav" aria-label="主导航"><a className="active" href="#monthly">月度汇总</a><a href="#topics">专题考点</a><a href="#sources">来源管理</a></nav><button className="top-action">＋ 添加资料</button></header>
    ...
    </div><footer className="footer"><span>时政 · 公考资料库</span><span>一个持续生长的备考知识库</span><span>© 2026</span></footer>
  </main>;
}
